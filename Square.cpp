...
int main(){
   ...
   int t;
    ...
    cin>>a1>>b1;
    cin>>a2>>b2;
    //for checking whether the result of adding two rectangles will produce a square or not 
    /*2 conditions:
    The first condition is, to make a square from two rectangles,
    both the rectangles should have same width or length then only we can make a square. 
    We cannot make a square from rectangles with different width and lengths.
    The second condition is, 
    the sum of width or length of two rectangles should be equal to the width or
    length of one of the rectangles.*/
