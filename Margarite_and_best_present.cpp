...
//TC: O(1)
//as if n=3 or if n=163736765
//both are odd numbers ,one is small and the other is large but of rboth of them function is running for just one time so it is not depending on the input so it is constant
// SC: O(1)
