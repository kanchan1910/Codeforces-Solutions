...
Otherwise, there will be a Void Absorption right after a Lightning Strike.
Supposing the hit point was x before casting these two spells, if you cast Lightning Strike first, 
after these two spells the hit point will be ⌊x−102⌋+10=⌊x2⌋+5, but if you cast Void Absorption first, 
after these two spells the hit point will be ⌊x2⌋, which is smaller.*/
while(n>0&&x>0&&x/2+10<x){
    n--;
    x=x/2+10;
}
x=x-(m*10);
